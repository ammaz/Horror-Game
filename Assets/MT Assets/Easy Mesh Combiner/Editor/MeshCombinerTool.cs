    ...
    public class MeshCombinerTool : EditorWindow
    {
        ...
        */
        ...
        void OnGUI()
        {
            ...
            GUILayout.Space(20);
            int spaceToRememberMessage = 132;
            ...
            meshCombinerPreferences.recalculateNormals = (bool)EditorGUILayout.Toggle(new GUIContent("Recalculate Normals",
                        ...
                        meshCombinerPreferences.recalculateNormals);

            meshCombinerPreferences.recalculateTangents = (bool)EditorGUILayout.Toggle(new GUIContent("Recalculate Tangents",
                        ...
                        meshCombinerPreferences.recalculateTangents);
        ...
        void CombineMeshes()
        {
            ...
            if (meshCombinerPreferences.recalculateNormals == true)
                finalMesh.RecalculateNormals();
            if (meshCombinerPreferences.recalculateTangents == true)
