...
namespace MTAssets.EasyMeshCombiner
{
    ...
    */
    ...
    public class RuntimeMeshCombiner : MonoBehaviour
    {
        ...
        [HideInInspector]
        public bool combineMeshesAtStartUp = false;
        [HideInInspector]
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                script.gizmosOfThisComponentIsDisabled = DisableGizmosInSceneView("RuntimeMeshCombiner", script.gizmosOfThisComponentIsDisabled);
                ...
                script.combineMeshesAtStartUp = EditorGUILayout.Toggle(new GUIContent("Combine On Start",
                                "Enable this option so that the informed meshes are automatically merged at the beginning of the game."),
                ...
                GUILayout.Space(GetInspectorWindowSize().x - 145);
                EditorGUILayout.LabelField("Size", GUILayout.Width(30));
                EditorGUILayout.IntField(script.targetMeshes.Count, GUILayout.Width(50));
                EditorGUILayout.EndHorizontal();
                GUILayout.BeginVertical("box");
                targetMeshes_ScrollPos = EditorGUILayout.BeginScrollView(targetMeshes_ScrollPos, GUIStyle.none, GUI.skin.verticalScrollbar, GUILayout.Width(GetInspectorWindowSize().x), GUILayout.Height(100));
        ...
        void Start()
        {
            ...
            if (combineMeshesAtStartUp == true)
            {
